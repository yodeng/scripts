...
if "degpathway" in module:
    ...
    for f in listresultdir:
        if os.path.basename(f) == "enrichment.Pathway.xlsx":           
            ...
            renamepic2("/lustre/work/yongdeng/RNA_Ref_template/image1.png",os.path.join(media,"image23"))
            renamepic2("/lustre/work/yongdeng/RNA_Ref_template/image1.png",os.path.join(media,"image24"))
